import deepquant.future1.test.robot_controller_test as robot_ctrl_test
import pandas
...
class IndividualBackTest:
    ...
    def backtest(self):
        ...
        asset_dataset = pandas.read_csv("")
        robot_backtest = robot_ctrl_test.Future1BackTest(asset_dataset)
        ...
        for row in range(start_row, end_row):
            ...
            # Get trading action
            trade_action = robot_backtest.run_trade(trade_input)
